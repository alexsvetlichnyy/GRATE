...
//$$$$$$$$$$$$$$$//Side B//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      ...
      histoManager.GetHisto2(3)->Fill(A,Ab);
	    ...
	    if(histoManager.GetStatType()<2.5){
	     //Gaimard-Schmidt and Ericson distributions
	      if(histoManager.GetStatType()>1.5  && A < 147 || histoManager.GetStatType()<1.5  && A < 0  ){energyB = 8*(1+0.004*randGauss.shoot())*A;}
	      else{
	...
	G4int RestFragmentZ_b=Zb;
        G4int RestFragmentA_b=Ab;
